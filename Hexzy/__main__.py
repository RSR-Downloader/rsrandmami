...
Hexzy_IMG = "https://telegra.ph/file/167b06c04843d14271a93.jpg"
...
def Hexzy_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [RSR](https://github.com/RSR-Downloader/rsrandmami) + [Mami](https://github.com/RSR-Downloader/mizokani) ."
